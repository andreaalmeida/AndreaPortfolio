...
<html lang="en">
	<head>
	  ...
	  <title>Bitovi Cover Letter - Andrea Pereira de Almeida</title>
	...
	<body>
		...
		<div class="pageTitle--index">
			<div class="pageTitle__container">
				<h1 class="h1_white">A cover letter to Bitovi</h1>
				<p class="p_white">Why I think I am a good fit as a UX designer on your team</p>
			</div>	
		</div>
...
<!-- 				<h2 class="categories">About me<h2>
 -->			</div>
			<div class="results__container">
				...
				<img class="result" src="images/bitovi/bitovi_result_1@2x.jpg" width="100%">
