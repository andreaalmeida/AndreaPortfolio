...
<html lang="en">
	<head>
	  	...
	  	<title>Live Fooda Style Guide - Andrea Pereira de Almeida</title>
	...
	<body>
		...
		<div class="pageTitle--project">
			<div class="pagetitle__container">
				<h1 class="h1_gray">Live Fooda style guide</h1>
		...
		<div class="description">
			<div class="description__container">
				...
				saw how much time we were wasting and created a style guide to make things more efficient going forward.  It included 
				styles for things like buttons, headings, and colors as well as a design language around forms. I created the style 
				guide using HTML and SASS.
				</p>
			</div>
		</div>
		<div class="results">
			...
			<div class="projectNav">
				...
				<a class="next" href="rize.php">Next project &#8594;</a>
			</div>	
		</div>
	</body>
